...
\begin{description} %% we are interested in this division
	...
	\begin{description} 
		...
		BDI belongs to a overloaded kind of logics cal modal logic which add meta language operators to
		...
		\end{description}
		Some of these entail from other. They are governed by the next rules
		\begin{itemize}
		\item hungry -> D-hunt
		\item D-hunt && x in y -> I-hunt
		\item I-hunt && x in y -> launch action go(y)
		\end{itemize}
		...
		crucial for a better integration of the social dynamics in the planning of goal achieving.
