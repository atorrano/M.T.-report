...
level rules, and relationship of basic constituents of the system.
Emergence cannot be predicted from only the constituents and their addition, following the reverse way of
reductionism. Even a small an simple set of rules can make a dynamic system generate emergent phenomena. 
...
Along the run
of the system there will appear 

Exemple : Volterra, dinamica equilibrada, Column fire run away


%TODO potser aquesta frase no cal
It is a sign that something is happening in a low level. There is a global sensivity to changes and
dynamics in the bottom layer.
%%%
