...
MAS = AI + distrib/parallel comput ?
...
Emergence cannot be predicted from only the constituents and their addition, the feedback must be taken into consideration. Emergence is a global effect produced by local dynamics. Exemple de la columna I una altre que sigui de social sciences...
...
%TODO Exemple de la columna i una altre que sigui de social sciences...
The Column example.\\
There is potential for emergent phenomena, i.e., when
\begin{itemize} 
\item Agent behaviour is non linear ( weight sum of variables), or is expressed with discontinuities, if-then rules in a categorical framework or in discrete non continous manner.
