...
we chosed simulation as technique to implement our calcules over the model...
justified above
...
which can be sumarized :
\begin{description}
\renewcommand{\labelitemi}{$\bullet$}
\renewcommand{\labelitemii}{$\cdot$}
\item [Definition of the target] (the purpose/question)
	\begin{description}
	...
	\end{description}
\item [Observations] : get parameters and initial conditions]
\item [Assumptions]
\item [Design model]
