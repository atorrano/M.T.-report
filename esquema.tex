...
bounded an tractable number of states of the environment :
table[state_i] = action_j then no agent is needed;

untractable number of states, combinatoric space -> feature and structure extraction to
infer the action to perform;
