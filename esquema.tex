...
pots lligar el b-u/t-d amb la granularity pq pots anar en una direccio o en altra canviant
la quantitat de detalls a base de posar tots els budells d'un object.

%TODO
tb esmenta : sociology tu un bottom definit fins on ella arriba... pero si el vols atravessar aniries
cap a l'antropologia, i si traveses mes bottons arribes a la psico, i encara mes arribes a la neurologia, etc etc fins els atoms.


%George Box
Although good modelling of the parts could be accomplished lefting out the non-relevant phenomena, citing the famous quote of George Box, the model will be wrong, what matters is whether it will be useful for us or not.\\
...
This last improvement and the use of MultiAgent Modelling in social modelling allowed to introduce the bottom layer of the social hierarchy of concepts, people and all the package of phenomena and issues associated to it. Once you are modelling a person you can work directly with personal or social relationships and their properties, arity, creation and destruction mechanisms, transitivity and interaction rules. This allows to solve models non solved before, like some cooperation, coordination and competition scenarios from game theory where several agents are involved, for instance. Also the direct interaction and feedback effects between the entities and the  environment can be represented in the model. Before this step, other paradigms could not cope with the intrinsic phenomena of people interacting in a social scenario. Different issues had to be modelled, agent decission process modelling and embedding of the Rational Choice Theory, heterogeneity in the entitites, bounded rationality, and complex psychology. As a last benefit to mention, modelling from a bottom-up point of view .... emergence... no t'oblidis de complx systm ...
...
........observations : get parameters and initial conditions\\
........assumptions\\
........design model\\
...
Les opcions estan limitades als casos contemplats (disseny amb regles, xarxa semÃƒ ntica,.... posa mes exemples).
...
converteix el model en una cosa tant difiÂ­cil d'entendre com l'objecte a modelar.
...
\\
		      ...
		      diferents no es poden modelitzar amb fiÂ­sica. 
\\
